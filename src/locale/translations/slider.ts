export default {
    en: {
        'slider.administration.label': "Administration",
        'slider.administration.title': "The power to serve",
        'slider.administration.header': "Administration",
        'slider.administration.description': "Configuration servers for a project. " +
            "Migrate a project to the new instance. " +
        ...
        'slider.development.header': "Development",
        'slider.development.description': "MVP, startups, landings, highload and corporate sites, CRM, CMC and mudules for them, etc",
